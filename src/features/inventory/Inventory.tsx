          ...
          {visibleItems.map((item) => (
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col justify-between">
                <div>
                  <p
                    className="font-semibold text-emerald-900 truncate"
                    title={item.name}
                  >
                    {item.name}
                  </p>
            ...
            <>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <Card className="p-4 bg-blue-50/50 border-blue-100 flex flex-col">
                  ...
                  <p className="text-xl font-bold text-blue-900 mt-1 truncate">
                    {dominantSeason}
                  </p>
                </Card>
                <Card className="p-4 bg-amber-50/50 border-amber-100 flex flex-col">
                  ...
                  <p className="text-xl font-bold text-amber-900 mt-1 truncate">
                    {topMaterial}
                  </p>
                </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="p-6 border-stone-200 shadow-sm flex flex-col">
                  <h3 className="text-sm font-semibold text-stone-700 uppercase mb-4 flex items-center gap-2">
                    <Zap className="h-4 w-4 text-stone-400" /> Composição de
                    Materiais
                  </h3>
